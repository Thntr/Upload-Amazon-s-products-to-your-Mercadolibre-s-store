...
for /l %%x in (1, 1, 1) do (
start cmd /k "cd /d C:\Users\ramzhacker\Documents\MEGA\TheHuntersCarpet\Wink_Inc\WinkAI\##WinkMLApp\#WinkAIMLApp\pythonSdkMaster\winktech\project\winkscraper & scrapy crawl winkSynch"
start chrome "%url%"
)
PAUSE