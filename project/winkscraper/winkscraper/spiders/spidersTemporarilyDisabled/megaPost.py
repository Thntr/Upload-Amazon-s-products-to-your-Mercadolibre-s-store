...
class megaPostTestSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        prime = response.css("#primePopoverContent > h1").css("::text").extract()
        ...
        try:
            ...
            '/html/body/div[2]/div[2]/div[4]/div[5]/div[3]/div/script[1]'
            xml = js2xml.parse(js)
        ...
        if items["availability"][0] == "Disponible." and items["prime"][0] == "Amazon Prime":
